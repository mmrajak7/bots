...
def _load_runtime() -> dict:
    ...
    cfg = dict(_DEFAULTS)
    # TWO LAYERS: config/flow_config.defaults.json (tracked, secret-free) under
    # config/flow_config.json (untracked, secrets). common/layered_config.py.
    file_cfg = layered_config.load('flow_config')
    if file_cfg:
        try:
