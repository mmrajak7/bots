...
Ported from CROCODILE for consistency and type safety.
"""
...
class KiteGTTStatus:
    """
    Kite Connect GTT Order Status Constants
    """
    ACTIVE = "active"
    TRIGGERED = "triggered"
    CANCELLED = "cancelled"
    ...
    TERMINAL_STATUSES = [TRIGGERED, CANCELLED, REJECTED, EXPIRED]

    @classmethod
    def is_terminal(cls, status: str) -> bool:
        """Check if GTT status is terminal"""
        return status.lower() in cls.TERMINAL_STATUSES
